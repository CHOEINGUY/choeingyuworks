...
const cycleValue = () => {
  ...
  if (isTooltipVisible.value) {
    ...
    if (nextNextOption.tooltip) {
      ...
      tooltipMessage.value = `${props.tooltipPrefix} ${nextNextOption.label}${props.tooltipSuffix}`;
    }
  } else {
...
const handleMouseEnter = () => {
  ...
  if (nextOption.tooltip) {
    ...
    tooltipMessage.value = `${props.tooltipPrefix} ${nextOption.label}${props.tooltipSuffix}`;
  }
