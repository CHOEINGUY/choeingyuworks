                ...
                const insights = [
                    ...
                    },
                    {
                        ...
                        description: [
                            ...
                            "문제 상황: 실시간 대기 관리 시스템 도입 후 현장 담당자들이 '완료 버튼'을 누르는 타이밍이 제각각이라 자동화 로직이 꼬이는 문제 발생.",
                            "고민: 처음에는 기술적으로 '강제하는 방법'(다음 순서 자동 넘김, 화면 조작 금지 등)을 고민했으나, 현장에는 늘 돌발 상황(변수)이 존재하기에 시스템을 경직되게 만들면 오히려 업무를 방해할 것이라 판단.",
                            "해결 방식: 기술적 제약 대신 '정확한 사용 가이드 교육'으로 접근. 시스템의 목표가 단순 기록이 아니라 '실시간 동료 간 상황 공유'임을 명확히 설명. 언제 버튼을 눌러야 가장 효율적인지 '정확한 타이밍'을 합의하고 교육.",
                            "결과: 사용자들이 시스템의 의도를 이해하자 자발적으로 정확한 데이터를 입력하기 시작. 시스템의 판단을 100% 신뢰하며 검진 진행 가능.",
