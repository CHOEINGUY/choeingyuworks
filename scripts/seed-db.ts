        ...
        const insights = [
            ...
            },
            {
                ...
                description: [
                    ...
                    "키워드: 현장 문제 해결, UX 개선, 실시간 데이터 동기화, 휴먼 에러 해결, 개발과 현실의 괴리",
                    "사례: 남원 코호트 프로젝트에서 '논리적으로 완벽한 코드'가 '현장의 리듬'을 깰 수 있다는 것을 깨달았습니다.",
                    "문제 상황: 실시간 검진 대기 시스템은 논리적으로 완벽했지만 현장 적용 시 데이터 불일치 문제 발생. 원인은 기술적 버그가 아니라 '사람'이었습니다. 검사자마다 '검사 완료' 버튼 누르는 타이밍이 제각각이었고 바쁠 땐 누르는 것을 잊기도 했습니다.",
                    "해결 방식: 기술적 강제(입력 막기, 자동 넘김)가 아닌 '프로세스의 재정의'를 선택. 버튼 하나가 전체 대기줄 해소에 어떤 영향을 미치는지 시각적으로 보여주고 사용자가 자발적으로 정확한 데이터를 입력하도록 유도.",
                    "결과: 시스템이 현장의 신뢰를 얻었고 매일 아침 발생하던 병목 현상을 자연스럽게 해소."
                ]
            },
            {
                ...
                description: [
                    ...
                    "전략 2 - Why의 공유: '이거 쓰세요'가 아니라 '이 버튼을 제때 눌러주시면 선생님 방 앞에 줄 서 있는 어르신들이 줄어듭니다'라며 그들의 업무 고충이 어떻게 해결되는지 설명했습니다.",
                    "전략 3 - 맞춤형 자료: IT 용어를 배제한 현장 맞춤형 서류 매뉴얼을 직접 제작해 배포했습니다.",
                    "결과: 담당자들이 시스템을 '감시자'가 아닌 '도우미'로 인식하기 시작. 입력 누락률이 0%에 가깝게 감소.",
