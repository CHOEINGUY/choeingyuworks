    ...
    <div className="h-full flex flex-col bg-white overflow-hidden relative font-sans">
      ...
      >
        ...
        <div className="flex items-center h-full mr-1 pr-1 border-r border-[#d3d3d3] py-1 flex-1 min-w-0">
          ...
          <span className="px-2 text-[15px] font-medium italic text-gray-500 font-serif">
            fx
          </span>
        ...
        <div className="flex items-center gap-2 flex-shrink-0">
          ...
          <div className="flex gap-0.5">
            <button
              className="flex items-center gap-1.5 px-2 h-[32px] rounded text-[#3c4043] hover:bg-[#f1f3f4] hover:text-[#1a73e8] transition-colors"
              title="확진여부"
            >
        ...
        <table className="w-full border-collapse table-fixed">
          ...
          <thead>
            ...
            <tr className="h-[35px]">
              ...
              <th
                rowSpan={2}
                className="border border-slate-300 bg-slate-100 text-center text-[12px] font-semibold text-slate-700"
              >
                연번
              </th>
              ...
              <th
                rowSpan={2}
                className="border border-slate-300 bg-slate-50 text-center text-[11px] font-medium text-slate-600 hover:bg-slate-100 leading-tight px-1"
              >
                환자여부
                <br />
                (1/0)
              ...
              <th
                colSpan={2}
                className="border border-slate-300 bg-slate-100 text-center text-[12px] font-medium text-slate-600 relative group"
              >
                기본정보
              </th>
              ...
              <th
                colSpan={3}
                className="border border-slate-300 bg-red-50 text-center text-[12px] font-bold text-red-600 border-b-red-200 relative group leading-tight"
              >
                임상증상
              </th>
              ...
              <th
                rowSpan={2}
                className="border border-slate-300 bg-slate-50 text-center text-[12px] font-medium text-slate-600"
              >
                증상발현시간
              </th>
              ...
              <th
                colSpan={9}
                className="border border-slate-300 bg-slate-50 text-center text-[12px] font-medium text-slate-600 relative group leading-tight"
              >
                식단(1/0)
                <div className="absolute top-1/2 left-1.5 -translate-y-1/2 flex gap-0.5 opacity-40 group-hover:opacity-100 transition-opacity">
                  <button className="w-[16px] h-[16px] flex items-center justify-center bg-white border border-slate-300 rounded text-[10px] hover:bg-blue-50 hover:text-blue-600 hover:border-blue-400">
                    +
                  </button>
                </div>
              </th>
            ...
            <tr className="h-[35px]">
              {/* Basic Sub */}
              <th className="border border-slate-300 bg-slate-50 text-center text-[12px] font-medium text-slate-600">
                grade
              </th>
              <th className="border border-slate-300 bg-slate-50 text-center text-[12px] font-medium text-slate-600">
                class
              ...
              {/* Clinical Sub */}
              <th className="border border-slate-300 bg-red-50/50 text-center text-[12px] font-medium text-red-600">
                diarrhea
              </th>
              <th className="border border-slate-300 bg-red-50/50 text-center text-[12px] font-medium text-red-600">
                vomit
