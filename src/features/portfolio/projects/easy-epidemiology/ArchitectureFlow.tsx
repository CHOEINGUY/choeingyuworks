                ...
                <div className="relative">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative z-10">
                        ...
                        <motion.div
                            ...
                            viewport={{ once: true }}
                            className="bg-slate-800 p-8 rounded-2xl border border-slate-700 relative group hover:border-blue-500/50 transition-colors min-w-0"
                        >
                        ...
                        <motion.div
                            ...
                            className="bg-slate-800 p-8 rounded-2xl border border-blue-500/30 relative shadow-[0_0_30px_rgba(59,130,246,0.1)] min-w-0"
                        >
                        ...
                        <motion.div
                            ...
                            className="bg-slate-800 p-8 rounded-2xl border border-slate-700 relative group hover:border-emerald-500/50 transition-colors min-w-0"
                        >
                            <div className="w-16 h-16 bg-slate-900 rounded-2xl flex items-center justify-center mb-6 border border-slate-700 group-hover:scale-110 transition-transform duration-300">
