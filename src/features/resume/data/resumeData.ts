export const RESUME_DATA = {
    ...
    ko: {
        ...
        skills: [
            ...
            {
                category: "업무 프로세스 자동화 (BPA)",
                items: [
                    "AppSheet, Google Apps Script : 수작업 업무 흐름 진단 및 앱 기반 시스템을 통한 DX 설계",
                    "Python(Flask), Google Cloud Run : 비즈니스 로직을 위한 커스텀 백엔드 서버 구축 및 시스템 연동"
                ]
            },
            {
                category: "연동 및 데이터 분석",
                items: [
...
// V2 Data override for experimentation
                ...
                projects: [
                    {
                        ...
                        details: [
                            ...
                            "데이터 분석 자동화 : SAS/Python/VBA 연동 HWPX 보고서 작성 자동화로 업무 기간 66% 단축 (3개월→1개월)",
